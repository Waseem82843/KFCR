function [K,opar]=movie_normalization(ixnorm,K,ipar)
...
% element-wise normalization by L2 norm           
           case 0
              ...
              [ix,jx,vx]=find(XTrain);
              m=length(ix);
              for i=1:m
                vx(i)=vx(i)/xsum1(ix(i));
              end
              XTrain=sparse(ix,jx,vx);
